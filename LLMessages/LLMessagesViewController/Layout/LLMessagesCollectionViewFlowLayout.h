...
FOUNDATION_EXPORT const CGFloat kLLMessagesCollectionViewCellLabelHeightDefault;
FOUNDATION_EXPORT const CGFloat kLLMessagesCollectionViewAvatarSizeDefault;
 ...
 */
@property (strong, nonatomic) id<LLMessagesBubblesSizeCalculating> bubbleSizeCalculator;
 ...
 *
 *  @discussion The default value is `(40.0f, 40.0f)`. Set to `CGSizeZero` to remove outgoing avatars.
 *  You may use `kLLMessagesCollectionViewAvatarSizeDefault` to size your avatars to the default value.
 */
...
/**
 *  Computes and returns the size of the `messageBubbleImageView` property of a `LLMessagesCollectionViewCell`
