...
//        UIView *view = [LLMessagesMediaPlaceholderView viewWithActivityIndicator];
//        view.frame = CGRectMake(0.0f, 0.0f, size.width, size.height);
//        [LLMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:view isOutgoing:self.appliesMediaViewMaskAsOutgoing];
...
- (BOOL)isEqual:(id)object
{
    ...
    LLMediaItem *item = (LLMediaItem *)object;
