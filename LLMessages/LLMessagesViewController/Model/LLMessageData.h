...
/**
 *  The `LLMessageData` protocol defines the common interface through which
 *  a `LLMessagesViewController` and `LLMessagesCollectionView` interact with message model objects.
 *
 ...
 *
 *  The class that conforms to this protocol is provided in the library. See `LLMessage`.
 *
 *  @see LLMessage.
 */
@protocol LLMessageData <NSObject>
 ...
 *  If this method returns `YES`, an instance of `LLMessagesViewController` will ignore
 *  the `text` method of this protocol when dequeuing a `LLMessagesCollectionViewCell`
